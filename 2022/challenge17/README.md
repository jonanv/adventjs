...
Estamos preparando los sacos para los regalos de Navidad pero cada saco tiene un <span style="color:yellow">límite de peso</span>.

Nos dan un array con los nombres de los regalos y un número que es el peso máximo que puede llevar cada saco. El <span style="color:yellow">peso de cada regalo es la longitud de su nombre</span>.
...
<span style="color:yellow">¡Pero ojo!</span> Cada saco puede llevar un máximo de peso, y si el peso de los regalos de un saco supera el peso máximo, se debe separar el último regalo del saco y ponerlo en el siguiente saco.
