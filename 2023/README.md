...
![AdventJs2023](../imgs/adventjs-2023.png)
...
pnpm run test:2023 # Para correr todos los test de todos los retos del año 2023

pnpm run test:yyyy:n # n siendo el numero del reto y yyyy el año, por ejemplo
pnpm run test:2023:01 # Correra el test del reto 1 del año 2023
```