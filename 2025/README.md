...
![AdventJs2025](../imgs/adventjs-2025.png)
...
pnpm run test:2025 # Para correr todos los test de todos los retos del año 2025

pnpm run test:yyyy:n # n siendo el numero del reto y yyyy el año, por ejemplo
pnpm run test:2025:01 # Correra el test del reto 1 del año 2025
```