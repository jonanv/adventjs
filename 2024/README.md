...
![AdventJs2024](../imgs/adventjs-2024.png)
...
| --------: | :-----------------------------------: | :-----------------: | :----------------------: | :------------: | :---: |
| [✅] #01  |    | [Show][c01-readme]  | [Solution][c01-solution] |       🟢       |  -  |
| [✅] #02  |    | [Show][c02-readme]  | [Solution][c02-solution] |       🟢       |  -  |
...
pnpm run test:2024 # Para correr todos los test de todos los retos del año 2024

pnpm run test:yyyy:n # n siendo el numero del reto y yyyy el año, por ejemplo
pnpm run test:2024:01 # Correra el test del reto 1 del año 2024
```